...
#' @export
''DashECharts <- function(id=NULL, bmap_token=NULL, brushSelected_data=NULL, brush_data=NULL, click_data=NULL, clicked_bar_data=NULL, enable_get_axisPointer_event=NULL, enable_get_clicked_bar_data_event=NULL, event=NULL, fun_effects=NULL, fun_keys=NULL, fun_paths=NULL, fun_prepares=NULL, fun_values=NULL, funs=NULL, mapbox_token=NULL, maps=NULL, n_clicks=NULL, n_clicks_timestamp=NULL, opt_merge=NULL, option=NULL, part_of_opt=NULL, reset_id=NULL, resize_id=NULL, selected_data=NULL, style=NULL, yAxisResize=NULL, yAxisRightClick=NULL, zoom_data=NULL) {
